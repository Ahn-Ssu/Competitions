...
archieve = ['seyonec/PubChem10M_SMILES_BPE_450k', "DeepChem/ChemBERTa-77M-MTR"]
chosen = archieve[1]
...
if __name__ == '__main__' : 
    ...
    pd.DataFrame(features).to_csv('/root/Competitions/DACON/4. JUMP AI 2023/data/rdkit_train.csv', index=False)
    ...
    pd.DataFrame(features).to_csv('/root/Competitions/DACON/4. JUMP AI 2023/data/rdkit_test.csv', index=False)
